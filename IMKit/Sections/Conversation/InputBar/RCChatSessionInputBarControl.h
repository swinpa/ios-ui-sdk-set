...
#define TOOLBAR_ITEM_ALBUM_TAG 1901
#define TOOLBAR_ITEM_CAMERA_TAG 1902


static NSInteger g_INPUT_MENTIONED_SELECT_TAG = INPUT_MENTIONED_SELECT_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_ALBUM_TAG = PLUGIN_BOARD_ITEM_ALBUM_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_CAMERA_TAG = PLUGIN_BOARD_ITEM_CAMERA_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_LOCATION_TAG = PLUGIN_BOARD_ITEM_LOCATION_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_DESTRUCT_TAG = PLUGIN_BOARD_ITEM_DESTRUCT_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_FILE_TAG = PLUGIN_BOARD_ITEM_FILE_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_VOIP_TAG = PLUGIN_BOARD_ITEM_VOIP_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_VIDEO_VOIP_TAG = PLUGIN_BOARD_ITEM_VIDEO_VOIP_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_EVA_TAG= PLUGIN_BOARD_ITEM_EVA_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_RED_PACKET_TAG = PLUGIN_BOARD_ITEM_RED_PACKET_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_VOICE_INPUT_TAG = PLUGIN_BOARD_ITEM_VOICE_INPUT_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_PTT_TAG = PLUGIN_BOARD_ITEM_PTT_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_CARD_TAG = PLUGIN_BOARD_ITEM_CARD_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_REMOTE_CONTROL_TAG = PLUGIN_BOARD_ITEM_REMOTE_CONTROL_TAG;
static NSInteger g_PLUGIN_BOARD_ITEM_TRANSFER_TAG = PLUGIN_BOARD_ITEM_TRANSFER_TAG;

static NSInteger g_TOOLBAR_ITEM_ALBUM_TAG = TOOLBAR_ITEM_ALBUM_TAG;
static NSInteger g_TOOLBAR_ITEM_CAMERA_TAG = TOOLBAR_ITEM_CAMERA_TAG;
...
@property (nonatomic, assign) CGFloat conversationViewHeight;
